...
public class Main {
    ...
    private static void testMetrics(List<task> tasks, Map<Integer, VM> vms, Map<String, Double> communicationCosts, 
        ...
        if (vf < 0.01) {
            ...
            System.out.println("     VF Interpretation: Good fairness (0.01 ≤ VF < 0.05) - moderate task satisfaction variance");
        } else if (vf < 0.1) {
            System.out.println("     VF Interpretation: Fair fairness (0.05 ≤ VF < 0.1) - noticeable task satisfaction differences");
        } else {
